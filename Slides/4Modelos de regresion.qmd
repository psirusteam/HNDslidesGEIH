...
\begin{eqnarray*}
W & = & diag\left\{ \frac{\omega_{1}}{V\left(\mu_{1}\right)\left[g'\left(\mu_{1}\right)\right]^{2}}, \cdots ,\frac{\omega_{n}}{V\left(\mu_{n}\right)\left[g'\left(\mu_{n}\right)\right]^{2}}\right\} 
\end{eqnarray*}
...
# Crear archivo PNG
png("Imagenes/04_Regresion/05_Fig_residuales_Regresion.png", width = 1000, height = 1000, res = 150)
par(mfrow = c(2, 2))
plot(mod_svy)
dev.off()
...
![Analisis de residuales ](Imagenes/04_Regresion/05_Fig_residuales_Regresion.png){width="350"}
...
```{r, echo = FALSE, eval = FALSE}
ggsave(plot = p1_hist, filename =  "Imagenes/04_Regresion/06_Fig_hist_residuales_Regresion.png")
```


## Histograma de los residuales

![Histogrma de los residuales stdresids  ](Imagenes/04_Regresion/06_Fig_hist_residuales_Regresion.png){width="300"}
...
```{r, echo = FALSE, eval = FALSE}
ggsave(plot = g6, filename =  "Imagenes/04_Regresion/07_Fig_Var_cosntante_Regresion.png")
```

## Varianza constante

![Varianza constante](Imagenes/04_Regresion/07_Fig_Var_cosntante_Regresion.png){width="300"}
...
```{r, echo = FALSE, eval = FALSE}
ggsave(plot = g_dcook, filename =  "Imagenes/04_Regresion/08_Fig_Distancia_cook_Regresion.png")
```
...
![Distancia de cook](Imagenes/04_Regresion/08_Fig_Distancia_cook_Regresion.png){width="250"}
...
```{r, echo = FALSE, eval = FALSE}
ggsave(plot = Fig_DFbetas, filename =  "Imagenes/04_Regresion/09_Fig_DFbetas_Regresion.png")
```


## Detección de observaciones influyentes ($D_{f}Betas_{\left(i\right)j}$)

![Detección de observaciones influyentes $D_{f}Betas_{\left(i\right)j}$](Imagenes/04_Regresion/09_Fig_DFbetas_Regresion.png){width="400"}
...
```{r, echo = FALSE, eval = FALSE}
ggsave(plot = g_dffits, filename =  "Imagenes/04_Regresion/10_Fig_DFfit_Regresion.png")
```


## Detección de observaciones influyentes ($D_{f}Fits_{\left(i\right)}$)

![Detección de observaciones influyentes $D_{f}Fits_{\left(i\right)}$](Imagenes/04_Regresion/10_Fig_DFfit_Regresion.png){width="400"}
...
```{r, echo = FALSE, eval = FALSE}
ggsave(plot = g_hat, filename =  "Imagenes/04_Regresion/11_Fig_hat_Regresion.png")
```
...
![Detección de observaciones influyentes $h_{ii}$](Imagenes/04_Regresion/11_Fig_hat_Regresion.png){width="300"}
...
\begin{eqnarray*}
\hat{E}(y_{i}\mid\boldsymbol{x}_{obs,i}) & = & 1.6840 + 0.8527x_{1i} -0.2417x_{2i} - 0.0951x_{3i}\\
       &=& 1.6840 + 0.8527(9.836) + -0.2417(1) - 0.0951(1) \\
       &=&  9.734
\end{eqnarray*}
...
```{r, echo = FALSE, eval = FALSE}
ggsave(plot = pred_mod, filename =  "Imagenes/04_Regresion/12_Fig_IC_pred_Regresion.png")
```


## Intervalo de confianza para la predicción

![Intervalo de confianza para la predicción](Imagenes/04_Regresion/12_Fig_IC_pred_Regresion.png){width="400"}
